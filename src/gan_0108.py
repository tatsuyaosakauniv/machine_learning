...
#データ前処理用の色々
#!!!parameters
data_step = 3000000 #MDのサンプルから取り出してくるデータ長
use_step  = 1000000   #学習に使うデータ長
...
#学習用トラジェクトリデータ
DATA_filename = "flow_check_top_0108.dat"                   #学習用ファイル
data_name = address + DATA_filename
...
time = np.arange(1,stepPlot)*dt*10**(-3)*stpRecord
ITR_pred /= 100
